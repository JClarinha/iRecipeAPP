...
export class NewRecipeComponent implements OnInit {
  ...
  SaveRecipe() {
    if (this.recipeForm.valid) {
      ...
      formData.append('userId', this.userId.toString()); // '0' como valor padrão se userId não estiver definido

      // Adicionar valores manualmente
      formData.append('approval', ''); // Adiciona '' como string
      ...
      console.log('Dados do formulário:', this.recipeForm.value);
